...
public class Decryptor {
	...
	static String Decrypt(String m) throws Exception{
		...
		byte ch = 0;
		for(int i = 0; i<len;i++) {
			FileInputStream f = new FileInputStream("C:/Users/DGTCP/eclipse-workspace/Project_Security/src/Decrypt_key1.txt");
			cypher++;
			if(cypher == 5)
				cypher=1;
			if(cypher==1 || cypher ==4) {
				f = new FileInputStream("C:/Users/DGTCP/eclipse-workspace/Project_Security/src/Decrypt_key1.txt");}
			if(cypher==2 || cypher ==3) {
				f = new FileInputStream("C:/Users/DGTCP/eclipse-workspace/Project_Security/src/Decrypt_key2.txt");}
